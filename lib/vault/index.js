...
exports.vaultIdentity = exports.keyVault = exports.virtualMachine = exports.networkInterface = void 0;
exports.setup = setup;
...
async function setup(input) {
    ...
    exports.vaultIdentity = new managedidentity_1.UserAssignedIdentity(`identity-vault`, {
    ...
    exports.vaultIdentity.principalId.apply(async (principalId) => {
        assignments.push(AzureRoles.assignRoleOutput({
