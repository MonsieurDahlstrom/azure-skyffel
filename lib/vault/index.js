...
exports.vaultIdentity =
  ...
  exports.setupKubernetesSecretEngine =
    void 0;
exports.setup = setup;
...
var kubernetes_secret_engine_1 = require('./kubernetes-secret-engine');
Object.defineProperty(exports, 'setupKubernetesSecretEngine', {
  enumerable: true,
  get: function () {
    return kubernetes_secret_engine_1.setupKubernetesSecretEngine;
  },
});
