...
function createCloudInitWithCertbot(input) {
  ...
  `;
    return configuration.apply((cloudInit) => Buffer.from(cloudInit).toString('base64'));
}
//# sourceMappingURL=cloud-init-certbot.js.map