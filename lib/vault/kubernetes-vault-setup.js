...
async function setup(args) {
    ...
    const vaultHelmChart = new kubernetes.helm.v3.Release('vault', {
        chart: 'vault',
        name: 'vault',
    ...
    const secret = new kubernetes.core.v1.Secret('vault-token', {
        metadata: {
            name: 'vault-token',
            namespace: 'vault',
            annotations: {
    ...
    const clusterrole = new kubernetes.rbac.v1.ClusterRole('vault-cluster-admin', {
        metadata: {
    ...
    const clusterrolebinding = new kubernetes.rbac.v1.ClusterRoleBinding('vault', {
        metadata: {
