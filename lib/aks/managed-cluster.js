...
exports.acns = exports.adminCredentials = exports.clusterIdentity = exports.cluster = void 0;
exports.setup = setup;
...
async function setup(input) {
    ...
    exports.clusterIdentity = new managedidentity_1.UserAssignedIdentity(`identity-${input.name}`, {
    ...
    exports.cluster = new containerservice_1.ManagedCluster(input.name, {
        agentPoolProfiles: [
            {
    ...
    exports.adminCredentials = (0, containerservice_1.listManagedClusterAdminCredentialsOutput)({
        resourceGroupName: input.resourceGroup.name,
