...
async function setup(input) {
    ...
    const tunnelSecretValue = await (0, utilities_1.GetValue)(tunnelSecret.base64);
    ...
    const vnetTunnelToken = await (0, utilities_1.GetValue)(vnetTunnel.tunnelToken);
    ...
    exports.networkInterface = new network_1.NetworkInterface('cloudflare-connector-nic', {
    ...
    //create vm
    let virtualMachineDependencies = [
        exports.networkInterface,
        vnetTunnel,
    ];
    exports.virtualMachine = new compute_1.VirtualMachine('cloudflare-connector-vm', {
